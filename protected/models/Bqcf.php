...
/**
 * This is the model class for table "bqcf".
 *
 * The followings are the available columns in table 'bqcf':
 ...
 * @property string $dmo
 */
class Bqcf extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bqcf the static model class
	 */
