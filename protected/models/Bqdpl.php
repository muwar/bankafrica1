...
/**
 * This is the model class for table "bqdpl".
 *
 * The followings are the available columns in table 'bqdpl':
 ...
 * @property string $dmo
 */
class Bqdpl extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bqdpl the static model class
	 */
