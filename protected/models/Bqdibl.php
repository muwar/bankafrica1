...
/**
 * This is the model class for table "bqdibl".
 *
 * The followings are the available columns in table 'bqdibl':
 * @property integer $d_id
 * @property integer $ibl_id
 * @property string $cus
 * @property string $sta
 ...
 * @property string $dmo
 */
class Bqdibl extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bqdibl the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
//			array('ibl_id, rate, amount, remark', 'required'),
			array('ibl_id, amount, proc', 'numerical', 'integerOnly'=>true),
			...
			array('d_id, ibl_id, cus, sta, rate, amount, proc, rejmot, remark, neg, drej, dval, uti, utimo, dou, dmo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ibl_id',$this->ibl_id);
