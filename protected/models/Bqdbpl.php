...
/**
 * This is the model class for table "bqdbpl".
 *
 * The followings are the available columns in table 'bqdbpl':
 ...
 * @property string $dmo
 */
class Bqdbpl extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bqdbpl the static model class
	 */
