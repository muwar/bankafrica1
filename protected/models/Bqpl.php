 ...
 * @property string $dmo
 */
class Bqpl extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bqpl the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('amo, brat', 'numerical'),
			array('cdos, per, sta, proc', 'length', 'max'=>5),
			...
			array('prat, drej, dval, dou, dmo', 'safe'),
	...
	public function search()
	{
		...
		$criteria->compare('prat',$this->prat,true);
