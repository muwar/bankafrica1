...
/**
 * This is the model class for table "bqlnom".
 *
 * The followings are the available columns in table 'bqlnom':
 ...
 * @property string $dmo
 */
class Bqlnom extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bqlnom the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('lib1, lib2, lib3, lib4, lib5, lib6, mnt1, mnt2, mnt3, mnt4, mnt5, mnt6, dt1, dt2, dt3, dt4, dt5, dt6', 'length', 'max'=>100),
			array('uti, utimo', 'length', 'max'=>10),
			array('dou, dmo', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('cdos, ctab, lib1, lib2, lib3, lib4, lib5, lib6, mnt1, mnt2, mnt3, mnt4, mnt5, mnt6, dt1, dt2, dt3, dt4, dt5, dt6, uti, utimo, dou, dmo', 'safe', 'on'=>'search'),
		);
	}
