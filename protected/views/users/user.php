...
//if ($model->tcus == 'pe') {
                    ...
                    <?php } else {
                        ...
                        <div class="form-group">
                            <?php // echo $form->labelEx($model, 'town'); ?>
                            <?php echo $form->textField($model1, 'link', array('size' => 50, 'class' => 'form-control', 'maxlength' => 50, 'placeholder' => 'Web address')); ?>
                    ...
                    ?>
                    <div class="form-group">
                        <input name="upload[]" type="file" multiple="multiple" id="filesToUpload"/>
                    </div>
