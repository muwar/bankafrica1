...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/timeline.css" />
      ...
      <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/font-awesome.min.css" />
       <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/intlTelInput.css" />
        ...
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/dataTables.responsive.css" rel="stylesheet">
    ...
    <body>
        ...
        <input type='hidden' id='base' align='center' value="<?php echo Yii::app()->baseUrl; ?>" style='background: white'/>
   ...
   <li>
                                <form  class="form-control">
                                 <?php echo CHtml::dropDownList('language', 'language', array( 'en'=>'English', 'fr'=>'French'), array('empty' => 'Select a language','onchange' => 'changelang()','id'=>'langdbox')); ?>
                                    
                                </form>
                            </li>
                            <li>
                                <form  class="form-control" role="form">
                                    <?php echo CHtml::dropDownList('country', 'id_countries', CHtml::listData(Countries::model()->findAll('id_countries=:w or id_countries=:x or id_countries=:y or id_countries=:z ', array(':w' => 38, ':x' => 81, ':y' => 110, ':z' => 154)), 'id_countries', 'name'), array('empty' => 'Select a country','onchange' => 'changecountry()', 'id'=>'countrydbox')); ?>
                                </form>
                            </li>
                          <li>
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse"><!--class="container" align="center" style="color:#ffd700;" style="height:auto; width:auto; "-->
                    ...
                    $this->widget('zii.widgets.CMenu', array(
                        'items' => array(
                            ...
                            array('label' => 'HOW IT WORKS', 'url' => array('/site/howto'), 'htmlOptions' => array('role' => 'presentation')),
                            array('label' => 'ABOUT US', 'url' => array('/site/about'), 'htmlOptions' => array('role' => 'presentation')),
...
<?php if ((Yii::app()->controller->id == 'site') && ((Yii::app()->controller->action->id == 'login')||(Yii::app()->controller->action->id == 'howto')||(Yii::app()->controller->action->id == 'about')||(Yii::app()->controller->action->id == 'contact'))) { ?>
                ...
                <article id="center_content">
                    <?php echo $content; ?>
                <?php } else {
                    if ((Yii::app()->controller->id == 'users') && (Yii::app()->controller->action->id == 'create')) {
                        ?>
    ...
    <?php } else { ?>
        <?php if ((Yii::app()->controller->id == 'site') && (Yii::app()->controller->action->id == 'index')) { ?>
            ...
            echo CHtml::link("<i class='fa fa-table fa-5x'></i> <br/>Inter-Bank Lending", array('/ibl')); ?>
                                                                </div>
...
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
   ...
   <footer class="footer" style="background:#125089;">
            <div class="container">
            <div class=row>
            <div class="col-md-12">
            <div class="col-md-3">
                <div class="footer-logo"><a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo.png" alt="" height="auto" width="20%"></a></div>
                </div>
                <div class="col-md-9">
                    <div class="col-md-3">
                    OUR PARTNERS
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.min.js"></script>
                       ...
                       <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/intlTelInput.min.js"></script>
...
$(document).ready(function() {
    ...
    function changelang(){
        var e = document.getElementById("langdbox").value;
         $.ajax({
                                                                    type: "GET",
                                                                    url: "http://" + document.getElementById("url").value+ "/"+document.getElementById("base").value+"/index.php?r=site/langchange&&" +
                                                                            "lang=" + e ,
                                                                    data: "", //ProposedSites
                                                                    cache: false,
...
var e = document.getElementById("countrydbox").value;
     $.ajax({
                                                                    type: "GET",
                                                                    url: "http://" + document.getElementById("url").value+ "/"+document.getElementById("base").value+"/index.php?r=site/countrychange&&" +
                                                                            "country=" + e ,
                                                                    data: "", //ProposedSites
                                                                    cache: false,
                                                                    success: function(data) {
